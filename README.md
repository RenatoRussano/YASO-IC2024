...
| Fase                | Data de Início | Data de Conclusão | Descrição                                                                               |
|---------------------|----------------|-------------------|-----------------------------------------------------------------------------------------|
| **Planejamento**    | Janeiro 2024   | Março 2024        | Definição do escopo do projeto, levantamento de requisitos, e criação do plano de projeto.|
| **Desenvolvimento** | Abril 2024     | Setembro 2024     | Desenvolvimento do MVP (Produto Mínimo Viável) com as funcionalidades básicas.           |
| **Testes**          | Setembro 2024  | Outubro 2024      | Testes de usabilidade, segurança, e performance, com ajustes e correções conforme necessário.|
| **Lançamento MVP**  | Outubro 2024   | Outubro 2024      | Lançamento do MVP, focado nas principais funcionalidades, como armazenamento e modo de emergência.|
| **Deploy Principal**| Fevereiro 2025 | Fevereiro 2025    | Lançamento oficial do aplicativo com todas as funcionalidades planejadas.               |
| **Atualização 1.0** | Junho 2025     | Junho 2025        | Primeira grande atualização com melhorias baseadas no feedback dos usuários.            |
| **Atualização 2.0** | Novembro 2025  | Novembro 2025     | Segunda atualização com novas funcionalidades e integração com APIs externas.           |
| **Atualização 3.0** | Janeiro 2026   | Janeiro 2026      | Terceira atualização com IA para análise de dados e recomendações personalizadas.       |
...
O desenvolvimento do Yaso apresenta várias dificuldades, principalmente devido à natureza sensível dos dados médicos e à necessidade de garantir uma segurança robusta para proteger esses dados. As principais dificuldades incluem:

- **Integração com APIs Externas:** Conectar o Yaso com sistemas de terceiros, como laboratórios e clínicas, de forma segura e eficiente é um grande desafio técnico e regulatório.
- **Garantia de Privacidade e Consentimento:** Implementar um sistema de tokens de consentimento que seja fácil de usar e ao mesmo tempo altamente seguro é uma tarefa complexa, exigindo um equilíbrio entre usabilidade e segurança.
- **Desenvolvimento Multiplataforma:** Criar uma experiência de usuário consistente em Android, iOS e web requer um planejamento cuidadoso e uma implementação técnica sólida.
- **Escalabilidade:** Garantir que o sistema seja escalável para suportar um grande número de usuários e integrações futuras sem comprometer o desempenho.

---

## Panorama Geral de Produtos Similares no Brasil

No Brasil, o mercado de aplicativos de saúde está crescendo, com várias iniciativas semelhantes ao Yaso surgindo nos últimos anos. Alguns exemplos incluem:

- **Meu Prontuário:** Um aplicativo que permite aos usuários armazenar e compartilhar seus dados médicos de forma segura, com foco em integração com laboratórios e clínicas.
- **Tummi:** Voltado para a gestão de consultas e exames, o Tummi oferece uma interface intuitiva para que os usuários mantenham seus dados médicos organizados.
- **Carefy:** Embora mais voltado para o gerenciamento de cuidados médicos e acompanhamento de tratamentos, o Carefy também permite a centralização de informações médicas, embora com menos foco em emergências.

Apesar dessas iniciativas, o Yaso se diferencia pela sua ênfase em acessibilidade em emergências e pelo modo família, que permite o compartilhamento controlado de informações com pessoas de confiança. Além disso, a proposta de segurança com tokens de consentimento criptografados é uma inovação que coloca o Yaso à frente em termos de proteção de dados sensíveis.
...
[![Yaso App Video](https://i.ibb.co/wSgdhz9/yaso-print-video.png)](https://youtu.be/Z1GFhgCzrBw?si=bjHAgoqGIfpcIFrM)

---

## Referências Externas

- **Protótipo:** [Arquivo Figma](https://www.figma.com/proto/3XUmM3L9cdklArVl9cCXy6/Yaso-Sa%C3%BAde?node-id=37-4&t=ZeSviwgXafwHlmp8-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=111%3A339&show-proto-sidebar=1)
- **Landing Page:** [Arquivo Figma](https://www.figma.com/proto/3XUmM3L9cdklArVl9cCXy6/Yaso-Sa%C3%BAde?node-id=147-747&t=qAla82eb7r7C9ypF-1&scaling=min-zoom&content-scaling=fixed&page-id=147%3A746)
- **Documentação:** [Google Drive](https://drive.google.com/file/d/1fpwh0LgB6dkvSUiL8Cttkm_q3FuVqZcf/view?usp=sharing)
